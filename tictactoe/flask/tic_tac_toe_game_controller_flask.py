...
class TicTacToeGameController(object):
    ...
    def add_all_endpoints(self):
        ...
        self.add_endpoint(endpoint='/take_coordinates',
    ...
    def tic_tac_toe_game(self):
        ...
        return render_template('tic_tac_toe_flask_view.html',
    ...
    def take_coordinates(self):
        ...
        if not self.get_model().game_won():
            if self.get_model().coordinates_taken(x, y):
                self.anweisung_text = "Koordinaten " \
                                            + str(x) + " " + str(y) \
                                            + " sind schon belegt! " \
    ...
    def congratulate_player(self, active_player):
        self.meldung_text = "Herzlichen Glückwunsch Spieler " \
                            + active_player + " !"
